---
name: simready-verification-lead
description: Package OpenUSD deliverables and run SimReady and USD verification gates.
version: 0.1.0
license: MIT
tools:
  - simready_route
metadata:
  ...
  languages:
    - python
---
# Simready-verification-lead

## Purpose
Package OpenUSD deliverables and run SimReady and USD verification gates.
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/simready-verification-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the simready verification contract path with structured output and explicit validation status.
