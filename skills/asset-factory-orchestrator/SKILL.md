---
name: asset-factory-orchestrator
description: Convert a run request into a skill sequence, provider assignment and validation plan.
version: 0.1.0
license: MIT
tools:
  - planning_route
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/asset-factory-orchestrator.
Run them from that repository against a blueprint checkout.
Eval cases cover the orchestration contract path with structured output and explicit validation status.
