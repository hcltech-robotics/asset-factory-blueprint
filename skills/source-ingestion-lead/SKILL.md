---
name: source-ingestion-lead
description: Inspect source assets, lineage, units, hierarchy and rights before mutation.
version: 0.1.0
license: MIT
tools:
...
metadata:
  ...
  languages:
    - python
---
# Source-ingestion-lead

## Purpose
Inspect source assets, lineage, units, hierarchy and rights before mutation.
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/source-ingestion-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the source ingestion contract path with structured output and explicit validation status.
