---
name: external-model-runner-lead
description: Run declared external models through manifest controlled execution.
version: 0.1.0
license: MIT
tools:
  - runtime_route
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/external-model-runner-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the external model execution contract path with structured output and explicit validation status.
