...
description: Record rights, provenance, review decisions, release status and retention.
version: 0.1.0
license: MIT
tools:
  - governance_record
...
## Purpose
Record rights, provenance, review decisions, release status and retention.
