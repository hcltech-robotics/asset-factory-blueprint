---
name: evaluation-validation-lead
description: Run schema, source, render, physics, articulation, runtime, RL and governance gates.
version: 0.1.0
license: MIT
tools:
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/evaluation-validation-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the evaluation contract path with structured output and explicit validation status.
