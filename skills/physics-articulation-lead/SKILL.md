---
name: physics-articulation-lead
description: Author physics plans, articulations and grasp affordances from validated or review-approved properties.
version: 0.1.0
license: MIT
tools:
  - physics_plan
...
metadata:
  tags:
    ...
    - physics
    - articulation
  domain: physics_articulation
  languages:
    - python
---
# Physics-articulation-lead

## Purpose
Author physics plans, articulations and grasp affordances from validated or review-approved properties.
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/physics-articulation-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the physics and articulation contract path with structured output and explicit validation status.
