...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/nonvisual-materials-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the nonvisual materials contract path with structured output and explicit validation status.
