---
name: reconstruction-lead
description: Create mesh geometry proposals from images, descriptions or source conversion and repair routes.
version: 0.1.0
license: MIT
tools:
  - geometry_route
...
## Purpose
Create mesh geometry proposals from images, descriptions or source conversion and repair routes.
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/reconstruction-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the reconstruction contract path with structured output and explicit validation status.
