---
name: segmentation-lead
description: Segment assets into semantic regions and condition mesh segments from governed evidence.
version: 0.1.0
license: MIT
tools:
...
## Purpose
Segment assets into semantic regions and condition mesh segments from governed evidence.
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/segmentation-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the segmentation and semantic inference contract path with structured output and explicit validation status.
