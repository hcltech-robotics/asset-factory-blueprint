...
description: Index operator backings, search the libraries and knowledge corpus and ground every prim, material and property in cited references.
version: 0.1.0
license: MIT
tools:
...
## Purpose
Index operator backings, search the libraries and knowledge corpus and ground every prim, material and property in cited references.
