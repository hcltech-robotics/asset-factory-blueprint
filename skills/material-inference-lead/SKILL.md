---
name: material-inference-lead
description: Infer material classes, bindings and physical property proposals from governed evidence.
version: 0.1.0
license: MIT
tools:
  - material_propose
...
metadata:
  ...
  languages:
    - python
---
# Material-inference-lead

## Purpose
Infer material classes, bindings and physical property proposals from governed evidence.
...
## Eval coverage
Benchmark and eval payloads for this skill live in the asset-factory-verification repository under skill-checks/material-inference-lead.
Run them from that repository against a blueprint checkout.
Eval cases cover the material and physical inference contract path with structured output and explicit validation status.
